...
class DefaultApi {
  ...
  Future<Response<AnalyzeResponse>> emojiCheckin({
    ...
    final _path = r'/emoji_checkin';            // Pfad und HTTP-Optionen definieren
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{                 // Prepare form data
        r'mood': encodeFormParameter(_serializers, mood, const FullType(String)),
        if (personality != null)
          r'personality': encodeFormParameter(
            _serializers,
            personality,
    ...
    final _response = await _dio.request<Object>(       // Send request with Dio
      _path,
      data: _bodyData,
      options: _options,
      cancelToken: cancelToken,
    ...
    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null     // Convert JSON response to a Dart object
          ? null
          : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AnalyzeResponse),
    ...
    return Response<AnalyzeResponse>(       // Return complete answer
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
